...
url = 'https://raw.githubusercontent.com/Sali00/telegram-proxies-collector/main/telegram channels.json'
...
for url_link in subscription_links:
    try:
        ...
        if 'Sali00' not in url_link:
            raw_array_links_content.append((url_link, links_content))
        elif 'Sali00' in url_link and 'channels' in url_link:
